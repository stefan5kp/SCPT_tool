...
SITE     = pd.read_csv("site.csv").rename(columns={'name':'site_name','latitude':'site_latitude','longitude':'site_longitude'})
CITATION = pd.read_csv("citation.csv")
CPT_META = pd.read_csv("conePenetrationTestMeta.csv")
CPT_DATA = pd.read_csv("conePenetrationTestArray.csv")
TT_META = pd.read_csv("travelTimeMeta.csv")
TT_DATA = pd.read_csv("travelTimeArray.csv")
DGWT_DATA = pd.read_csv("DGWT.csv")
VEL_META = pd.read_csv("velocityProfileMeta.csv")
VEL_DATA = pd.read_csv("velocityProfileArray.csv")
