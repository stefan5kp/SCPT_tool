...
**User Guide**  
    - If you wanted to purely interpret the traveltime data into stepped Vs profiles from SCPT, please use the direct interpretation tool  
    - If you wanted to estimate Vs profiles from purely cone penetration data, please use the national model tool  
    - Site-specific joint algorithm that leverage both the traveltime and cone penetration data is coming soon  
